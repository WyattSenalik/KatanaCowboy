...
namespace SoundSystem
{
    ...
    public class Sound : ScriptableObject, ISound
    {
        ...
        /// </summary>
        /// <returns>Instance of the sound being played.</returns>
        public ISoundInstance PlayAsFlat()
        {
        ...
        /// <summary>
        /// Plays the sound as a 3D sound at the given position.
        /// </summary>
        /// <returns>Instance of the sound being played.</returns>
        public ISoundInstance PlayAs3D(Vector3 position)
        {
